...
public class Weights {
    ...
    public static boolean checkWeightLimit(String vehicleId, String portId, Map<String, Integer> containerData, Map<String, int[]> portData, Map<String, String[]> vehicleData) {
        int totalWeight = 0;
        String[] containers = vehicleData.get(vehicleId);
        ...
        int[] portLimits = portData.get(portId);
        if (portLimits != null) {
